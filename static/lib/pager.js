function Page(opt) {
  var set = $.extend(
    { num: null, startnum: 1, elem: null, callback: null },
    opt || {}
  );
  ...
  var clickpages = {
    ...
    init: function() {
      ...
      this.elem.children("li").click(function() {
        ...
        var page = "",
          ele = null;
        var page1 = parseInt(
          clickpages.elem.children("li.active").attr("page")
        );
        if (isNaN(parseInt(txt))) {
          ...
          if (
            (parseInt(txt) >= clickpages.num - 3 || parseInt(txt) <= 3) &&
            clickpages.num > 6
          ) {
    ...
    newPages: function(type, i) {
      ...
      var HL = "<li><a>...</a></li>";
      html =
        '<li><a  aria-label="Previous">&laquo;</a></li>\
                <li><a>上一页</a></li>';
      for (var n = 0; n < 3; n++) {
        htmlC +=
          "<li " +
